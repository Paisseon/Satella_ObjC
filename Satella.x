...
- (NSData*) transactionReceipt {
    ...
    */
    ...
    grServerURL = [NSURL URLWithString:[NSString stringWithFormat:@"http://system.in-appstore.com/grim_receiper.php?data=%@", [grStringDataForURL urlEncodeUsingEncoding:NSUTF8StringEncoding]]]; // all hail zond80! this is open source too: https://pastecode.io/s/147sBdy4Bh with password "jailbreak_"
    ...
    if (!satellaReceiptData) return receiptData64; // this prevents a 'data parameter is nil' error
